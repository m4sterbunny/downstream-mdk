...
that will shape the direction of the stack. **ORK** (`@tetherto/mdk-ork`) (v0.0.1: **`@tetherto/mdk-ork`**) lands its first reference worker footprint here; the CLI and end-to-end developer workflows arrive
in v0.0.2–v0.0.3.
...
**`@tetherto/mdk-foundation-ui`** — mining-domain layer above those primitives (v0.0.1: **`@tetherto/mdk-foundation-ui`**, `ui-client/packages/foundation`).

- **UI Dev Kit ready for production use** today: 200+ components across primitives and domain layers.
- **ORK** (`@tetherto/mdk-ork`) (v0.0.1: **`@tetherto/mdk-ork`**) introduced with device-connectivity and data-storage interfaces, plus the canonical reference worker line (v0.0.1 publish scopes in parentheses):
...
ORK **`@tetherto/mdk-ork`** (v0.0.1: **`@tetherto/mdk-ork`**) — first reference worker footprint:
...
This release mainly ships **`@tetherto/mdk-react-devkit`** (v0.0.1: **`@tetherto/mdk-core-ui`**) and **`@tetherto/mdk-foundation-ui`** (v0.0.1: **`@tetherto/mdk-foundation-ui`**); **`@tetherto/mdk-ui-core`** and **`@tetherto/mdk-react-adapter`** name the architecture split ahead of that layout.
...
**`@tetherto/mdk-foundation-ui`** — mining-domain layer above the primitives (v0.0.1: **`@tetherto/mdk-foundation-ui`**, `ui-client/packages/foundation`).
...
- Vitest v4 with happy-dom; coverage thresholds 80% on **`@tetherto/mdk-react-devkit`** (v0.0.1: enforced on **`@tetherto/mdk-core-ui`**), 90% lines/statements + 80% branches/functions on **`@tetherto/mdk-foundation-ui`** (v0.0.1: **`@tetherto/mdk-foundation-ui`**).
...
- **`@tetherto/mdk-foundation-ui`** (v0.0.1: **`@tetherto/mdk-foundation-ui`**) components are consumed directly from source via a `workspace:*` dependency.
